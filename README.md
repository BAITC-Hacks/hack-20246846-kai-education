...
Этап 4 не реализован. Из известных ограничений: нет авторизации, пагинации, снятия публикации, отмены принятия команды, уведомлений и UI этих сценариев. Смысловые неточности вопросов AI из этапа 2 требуют ручной проверки; новый AI workflow не добавлялся.
